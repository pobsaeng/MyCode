class AnimateXYPlotting {
    constructor() {
        this.SOURCE_IMAGE = "images/argiano.jpg";
        this.SIZE = 50;  // width and height for the image
        this.MARGIN_LEFT = 15;  // left-margin for the container
        this.MARGIN_TOP = 50; // top-margin for the container
        // x, y coordinates of the items
        this.X_MIN = 0;
        this.Y_MIN = 0;
        this.X_MAX = 600;
        this.Y_MAX = 300;
        this.WIDTH = this.X_MAX - this.X_MIN + 1;
        this.HEIGHT = this.Y_MAX - this.Y_MIN + 1;
        this.numItems = 0;
        this.init();
    }
