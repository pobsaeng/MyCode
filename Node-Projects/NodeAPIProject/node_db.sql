...
-- Dumping data for table node_db.tbl_book: ~13 rows (approximately)
...
-- Dumping data for table node_db.tbl_product: ~4 rows (approximately)
...
-- Dumping data for table node_db.tbl_role: ~0 rows (approximately)
...
-- Dumping data for table node_db.tbl_user: ~1 rows (approximately)
...
-- Dumping data for table node_db.tb_group_product: ~5 rows (approximately)
