...
import com.multibank.repository.SubMenuRepository;
...
//			Optional<SubMenu> sub = subMenuRepository.findById(listItems.get(2).getMenu_id());
//			System.out.println(sub);
			Map<String, Object> m = new HashMap<String, Object>();
			Map<Set<String>, Menu> maps = new HashMap<Set<String>, Menu>();
...
//						Optional<Menu> menu = menuRepository.findById(item.getMenu_id());
//						if(menu.isPresent()) {
//							m.put("item", menu.get());
//							lobj.add(item);
//							lobj.add(m);
